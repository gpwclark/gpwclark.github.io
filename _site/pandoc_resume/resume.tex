...
\section[george-price-w.-clark]{George Price W. Clark}
...
\startdescription{2010-2015}
  {\bf BA, Computer Science and Economics}; The University of North
...
\startblockquote
\useURL[url4][mailto:email@example.com][][\hyphenatedurl{email@example.com}]\from[url4]
